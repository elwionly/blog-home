...
import { MENULINKS, SKILLS } from '~/store/constants'
      ...
      <div class="skills-wrapper flex flex-col">
        ...
        <div class="flex flex-col">
          ...
          <h2 class="seq mt-2 w-full text-2xl md:max-w-2xl">
            我喜欢负责使用现代前端架构来制作美观的用户体验，同时也能提高开发效率。
          </h2>
        </div>
        <div class="mt-10">
          <renderSkillColumn :skills="SKILLS.frontend" :will-change="willChange" title="前端开发" />
        </div>
        <div class="mt-10 flex flex-wrap">
          <div class="mb-6 mr-6">
            <renderSkillColumn :skills="SKILLS.userInterface" :will-change="willChange" title="UI设计" />
          </div>
          <div>
